	...
	return (
		<Router>
			<Switch>
				...
				<PrivateRoute exact path='/services/payments/view/:id' component={ServiceOrder} />
				{/* instructions */}
				<PrivateRoute exact path='/insrtuctions' component={Insrtuctions} />
				{/* Schedule */}
				<PrivateRoute exact path='/schedule' component={Schedule} />
				<PrivateRoute exact path='/schedule/add-appointment' component={AddSchedule} />
				<PrivateRoute exact path='/schedule/edit-appointment/view/:id' component={AddSchedule} />
				{/* Staff Schedule */}
				<PrivateRoute exact path='/staff-schedule/add-staff-schedule' component={StaffSchedule} />
