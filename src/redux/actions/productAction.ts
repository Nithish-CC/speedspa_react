import { LOADING_UI, CLEAR_ERRORS, SET_ERRORS, BUTTON_LOADING, LOADING_CLEAR, SET_PRODUCT_CATEGORIES, SET_PRODUCT_CATEGORY, SET_PRODUCTS, SET_PRODUCT_VIEW, SET_PRODUCT_CATEGORIES_DATA, SET_PRODUCT_ORDER, SET_PRODUCT_ORDER_DATA } from '../types'
...
export const addProductProduct = (params: any, history: any) => (dispatch: any) => {
	dispatch({ type: BUTTON_LOADING })
	axios
...
export const getProductProductView = (Id: any, params: any) => (dispatch: any) => {
	dispatch({ type: LOADING_UI })
	axios
...
export const getProductProductUpdate = (params: any, history: any) => (dispatch: any) => {
	dispatch({ type: BUTTON_LOADING })
	axios
...
export const getProductOrderUpdate = (orderId: any, params: any, history: any) => (dispatch: any) => {
	dispatch({ type: BUTTON_LOADING })
	axios
...
export const addProductOrder = (params: any, callback: any) => (dispatch: any) => {
...
export const updateProductOrder = (id: any, params: any, history: any, callback: any) => (dispatch: any) => {
	axios.defaults.headers.common['x-populate'] = 'clientId,serviceId'
	dispatch({ type: BUTTON_LOADING })
	axios
...
export const getProductOrderView = (Id: any, params: any) => (dispatch: any) => {
	axios.defaults.headers.common['x-populate'] = 'clientId,serviceId'
	dispatch({ type: LOADING_UI })
	axios
...
export const addProductUpdateStaffOrder = (params: any, callback: any) => (dispatch: any) => {
	axios.defaults.headers.common['x-populate'] = 'clientId,serviceId'
	dispatch({ type: BUTTON_LOADING })
	axios
