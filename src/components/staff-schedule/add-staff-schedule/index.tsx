...
import { schedule,updateSchedule,deleteSchedule } from "../../../redux/actions/scheduleActions";
...
const ScheduleStaff = (props: any) => {
	...
	const schedules = () => {
		let start = "2021-09-30T23:59:59.999Z";
	...
	const timeSlots = () => {
		let start = "2021-09-30T23:59:59.999Z";
		let end = "2021-11-01T00:00:00.000Z";
		var data: any = {
			timeStart: {
				$lte: end,
				$gt: start,
	...
	const deletePopup = (appointment: any) => {
		setModalPopup({
			...
			startDate:moment.parseZone(appointment.startStr).utc().format('MMMM Do YYYY, h:mm:ss a'),
			endDate:moment.parseZone(appointment.endStr).utc().format('MMMM Do YYYY, h:mm:ss a')
		})
	}
	...
	const calendarData = () => {
		setReSchedule(false)
		const tempArr: any[] = [];
		const selectedStaff= _.filter(scheduleData, (scheduleData) => scheduleData.resourceId === staffSelected);
	...
	const handleMouseClick = (info: AnyObject) => {
		...
		const mainService = _.filter(allStaff, (serviceDetails:any) => serviceDetails.name === info.event.title);
												...
												<Form className="form-horizontal">
													<FormGroup>
														<Col lg="12">
															...
															<FormControl
																...
																name="eventStaff"
																value={staff}
																onChange={(e: any) => setStaff(e.target.value)}>
																{allStaff &&
																	allStaff.length &&
													...
													<FormGroup>
														<div className="col-lg-2">
															<FormLabel className="control-label">Start Time</FormLabel>
															<FormGroup>
														...
														<div className="col-lg-2">
															<FormLabel className="control-label">End Time</FormLabel>
															<FormGroup>
																<div className="col-lg-5">
																	<div className="input-group">
																		<TimePicker
													...
													<FormGroup>
														<Col lg="12">
															<Button className="btn btn-white" style={{backgroundColor:"white",color:"black"}} type="button" onClick={()=>setReSchedule(false)}>
																Cancel
															</Button>
															&nbsp;
													...
													<FormGroup>
														<div className="col-lg-12">
															<span>
																<strong>Note: </strong> You don't allow to modify this
																schedule. If you want to reschedule please contact
																admin.
															</span>
														</div>
													</FormGroup>
...
const mapActionsToProps = { getAllStaff, schedule, getRootServiceCategory,updateSchedule,deleteSchedule };
