			...
			<div className='row wrapper border-bottom white-bg page-heading' style={{ padding: '10px' }}>
				<div className='col-sm-12'>
					...
					{false && (
						...
						>
							<a className='btn btn-sm btn-primary' href='#/' style={{ marginRight: '5px' }}>
								button
							</a>
						</div>
					)}
						...
						<div className='ibox float-e-margins'>
							<div className='ibox-content'>
								<form className='form-horizontal'>
									{showSuccessResponse && (
										<div className='row' data-ng-show='vm.success.length'>
											<div className='col-md-8'>
												<div className='text-success m-t-md m-b-md'>Thank you! Message was sent!</div>
											</div>
										</div>
									)}
									{showErrorResponse && (
										<div className='row' data-ng-show='vm.errors.length'>
											<div className='col-md-8'>
												<div className='text-danger m-t-md m-b-md'>Error sending message. Try again!</div>
											</div>
										</div>
									)}
									<div className='form-group'>
										<label className='col-md-2 col-sm-3 col-xs-4 control-label'>Type</label>
									...
									<div className='form-group'>
										<label className='col-md-2 col-sm-3 col-xs-4 control-label'>Title</label>
										<div className='col-md-4 col-sm-5 col-xs-8'>
											<input
												type='text'
									...
									<div className='form-group m-t-sm'>
										<label className='col-md-2 col-sm-3 col-xs-4 control-label'>Message</label>
									...
									{type === 'SMS' && (
										<div className='form-group' ng-if="vm.message.type =='SMS'">
											<label className='col-md-2 col-sm-3 col-xs-4 control-label'>Image</label>
											<div className='col-md-4 col-sm-5 col-xs-8'>
												<input type='file' className='form-control' id='fileToUpload' />
											</div>
										</div>
									)}
